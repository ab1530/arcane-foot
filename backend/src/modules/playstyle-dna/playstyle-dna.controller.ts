...
import { ClassifyPlayerDto, ComparePlayersDto } from './dto/playstyle-dna.dto';
...
export class PlaystyleDnaController {
  ...
  @ApiOperation({
    ...
    description:
      'Use ML to classify a player into one of 12 playing styles based on their attributes. Requires GOLD subscription or higher.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Get complete PlayStyle DNA profile for a player. Requires GOLD subscription or higher.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Find players with similar playing styles based on DNA profile. Requires GOLD subscription or higher.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Compare playing styles and attributes of two players. Requires GOLD subscription or higher.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Get radar chart data for player visualization. Requires GOLD subscription or higher.',
  })
  @ApiParam({ name: 'playerId', description: 'Player ID' })
  @ApiResponse({
    status: 200,
