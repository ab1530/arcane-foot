export const en = {
  ...
  auth: {
    ...
    roleHint: 'Admin and Super Admin are managed with the same access profile.',
    roleModalTitle: 'Choose profile',
  ...
  calendarCenter: {
    ...
    title: 'Match Center',
    subtitle:
      'Track scheduled fixtures, dispatch scouts and visualize venues at a glance.',
    viewModes: {
      list: 'List',
      week: 'Week',
      day: 'Day',
    ...
    shareCta: 'Share your calendar',
    shareHeadline: 'Arcane Calendar',
    weekCurrentHint: 'Current week',
    weekSelectedHint: 'Selected week',
    weekCurrentCta: 'Back to current week',
    emptyTitle: 'No scheduled events',
    emptyBody: 'No items for this filter.',
    teamsTbd: 'To be confirmed',
    assignedSingle: 'assigned',
    assignedPlural: 'assigned',
    createReportCta: 'Create report',
    mapUnavailableTitle: 'Map unavailable',
    mapUnavailableBody: 'react-native-maps is not available on this build.',
    statusLabels: {
      PLANNED: 'Planned',
      EN_ROUTE: 'En route',
    ...
    detailEmptyTitle: 'No match data available.',
    detailEmptyBody: 'Please go back and select a fixture.',
    detailEyebrow: 'Scheduled fixture',
    detailInfoSection: 'Information',
    detailAssignmentsSection: 'Assigned scouts',
    detailNoAssignments: 'No scout is assigned to this match.',
    detailAssignedScout: 'Assigned scout',
    detailNotesSection: 'Notes',
    detailDateLabel: 'Date',
    detailTimeLabel: 'Time',
    detailCompetitionLabel: 'Competition',
    detailVenueLabel: 'Venue',
    detailStatusLabel: 'Status',
    detailTbd: 'To be confirmed',
  },
  profile: {
    header: {
      title: 'My profile',
