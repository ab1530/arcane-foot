export const fr = {
  ...
  auth: {
    ...
    roleHint: 'Admin et Super Admin sont gérés avec le même profil.',
    roleModalTitle: 'Choisir un profil',
    roleModalClose: 'Fermer',
  ...
  dashboard: {
    ...
    stats: {
      ...
      roleCards: {
        reports: 'Rapports',
        players: 'Joueurs scoutés',
        calendar: 'Calendrier',
        transfermarkt: 'Transfermarkt',
        scouts: 'Scouts',
        agentRequests: 'Demandes agent',
      },
    },
    quickActions: {
  ...
  calendarCenter: {
    ...
    shareCta: 'Partager votre calendrier',
    shareHeadline: 'Arcane Calendar',
    weekCurrentHint: 'Semaine en cours',
    weekSelectedHint: 'Semaine sélectionnée',
    weekCurrentCta: 'Revenir à cette semaine',
    emptyTitle: 'Aucun rendez-vous planifié',
    emptyBody: 'Aucun élément pour ce filtre.',
    teamsTbd: 'À confirmer',
    assignedSingle: 'assigné',
    assignedPlural: 'assignés',
    createReportCta: 'Créer rapport',
    mapUnavailableTitle: 'Carte indisponible',
    mapUnavailableBody: "react-native-maps n'est pas disponible sur cette build.",
    statusLabels: {
      PLANNED: 'Planned',
      EN_ROUTE: 'En route',
    ...
    detailTitle: 'Détails du match',
    detailEmptyTitle: 'Aucune donnée de match disponible.',
    detailEmptyBody: 'Veuillez revenir en arrière et sélectionner une rencontre.',
    detailEyebrow: 'Rencontre programmée',
    detailInfoSection: 'Informations',
    detailAssignmentsSection: 'Scouts assignés',
    detailNoAssignments: "Aucun scout n'est assigné pour ce match.",
    detailAssignedScout: 'Scout assigné',
    detailNotesSection: 'Notes',
    detailDateLabel: 'Date',
    detailTimeLabel: 'Heure',
    detailCompetitionLabel: 'Compétition',
    detailVenueLabel: 'Stade',
    detailStatusLabel: 'Statut',
    detailTbd: 'À confirmer',
  },
  profile: {
    header: {
      title: 'Mon profil',
  ...
  players: {
    ...
    profileView: {
      ...
      sections: {
        decisionBoard: 'Vue décision club',
        scouting: 'Résumé scouting',
        performance: 'Performance data',
        hardware: 'Hardware sync',
        media: 'Vidéos / Highlights',
        market: 'Marché',
        transfers: 'Historique transferts',
        career: 'Historique carrière',
        nationalTeam: 'Parcours national',
        achievements: 'Palmarès',
        news: 'News',
        rumours: 'Rumeurs',
      },
      labels: {
        ...
        goalParticipation: 'Implication buts',
        startingXI: 'Titulaire',
        ...
        sprintDistance: 'Distance sprint',
      ...
      actions: {
        ...
        statusVerify: 'Vérifier',
        statusPublish: 'Publier',
        statusArchive: 'Archiver',
      },
      editor: {
        createTitle: 'Ajouter un élément',
        editTitle: 'Modifier un élément',
        sourceRequiredTitle: 'Source requise',
        sourceRequiredMessage: 'Le champ sourceName est obligatoire pour cette section.',
        deleteConfirm: 'Confirmer la suppression de cet élément ?',
      },
      market: {
        linkUnavailableTitle: 'Lien indisponible',
        linkUnavailableMessage: 'Aucun lien externe n’est configuré pour ce joueur.',
        openFailedTitle: 'Ouverture impossible',
        openFailedMessage: 'Impossible d’ouvrir ce lien.',
      },
      empty: {
        noData: 'Aucune donnée vérifiée',
        noHardware: 'Aucune session synchronisée',
        noVideos: 'Aucune vidéo highlight disponible.',
      },
      errors: {
        genericTitle: 'Erreur',
        ...
        statusFailed: 'Impossible de changer le statut avec cette transition.',
      },
    },
  },
  ai: {
  ...
  passportPreview: {
    ...
    labels: {
      ...
      marketLink: 'Lien marché',
      qrFallback: 'QR secondaire (fallback)',
      lastUpdated: 'Dernière mise à jour',
    },
    units: {
      years: 'ans',
    ...
    actions: {
      openLink: 'Ouvrir lien',
      copyLink: 'Copier lien',
      shareLink: 'Partager',
      openMarket: 'Marché externe',
      addToGroup: 'Ajouter au groupe',
      showQr: 'Afficher QR (optionnel)',
      hideQr: 'Masquer QR',
    },
    media: {
      video: 'Vidéo',
    ...
    empty: {
      freeAgent: 'Libre',
      stats: 'Aucune statistique exploitable disponible.',
      media: 'Aucun média highlight disponible.',
      link: 'Lien indisponible',
      marketLink: 'Aucun lien marché disponible pour ce joueur.',
    },
    errors: {
      title: 'Erreur',
      load: 'Impossible de charger le passeport',
      linkTitle: 'Lien indisponible',
      linkUnavailable: 'Aucun lien public disponible pour ce passeport.',
      openTitle: 'Ouverture impossible',
      openBody: 'Le lien n’a pas pu être ouvert.',
      shareTitle: 'Partage impossible',
      shareBody: 'Le partage du lien a échoué.',
      qrMissing: 'Token manquant (impossible d’afficher le QR)',
    },
    toasts: {
      linkCopiedTitle: 'Lien copié',
      linkCopiedBody: 'Le lien du passeport est dans le presse-papiers.',
      shareReadyTitle: 'Lien prêt',
      shareReadyBody: 'Lien copié et menu de partage ouvert.',
      missingContextTitle: 'Contexte manquant',
      missingContextBody: 'Ouvre ce passeport depuis Besoins clubs pour l’ajouter au partage.',
      addReadyTitle: 'Ajout prêt',
      addReadyBody: 'Retour sur Besoins clubs avec ce joueur ajouté au groupe.',
    },
  },
  playerProfile: {
    title: 'Dossier joueur',
    loading: 'Chargement du dossier…',
    empty: 'Aucune donnée vérifiée',
    actions: {
      edit: 'Éditer',
      saveDraft: 'Save Draft',
      verify: 'Verify',
