...
export const ARCANE_CONTRAST_TESTS = {
  ...
  whiteonDark: {
    fg: '#FFFFFF',
    bg: '#01071d',
    ratio: getContrastRatio('#FFFFFF', '#01071d'),
    passes: meetsWCAG_AA('#FFFFFF', '#01071d'),
  },
  accentOnDark: {
    fg: '#e6ff3c',
    bg: '#01071d',
    ratio: getContrastRatio('#e6ff3c', '#01071d'),
    passes: meetsWCAG_AA('#e6ff3c', '#01071d'),
  },
  greyOnDark: {
    fg: '#b3afb2',
    bg: '#01071d',
    ratio: getContrastRatio('#b3afb2', '#01071d'),
    passes: meetsWCAG_AA('#b3afb2', '#01071d'),
  },
  darkOnAccent: {
    fg: '#01071d',
    bg: '#e6ff3c',
    ratio: getContrastRatio('#01071d', '#e6ff3c'),
    passes: meetsWCAG_AA('#01071d', '#e6ff3c'),
  },
  // Card combinations
  whiteOnCard: {
    fg: '#FFFFFF',
    bg: '#353439',
    ratio: getContrastRatio('#FFFFFF', '#353439'),
    passes: meetsWCAG_AA('#FFFFFF', '#353439'),
  },
  greyOnCard: {
    fg: '#b3afb2',
    bg: '#353439',
    ratio: getContrastRatio('#b3afb2', '#353439'),
    passes: meetsWCAG_AA('#b3afb2', '#353439'),
  },
};
